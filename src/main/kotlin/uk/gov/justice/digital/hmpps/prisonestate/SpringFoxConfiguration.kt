...
import uk.gov.justice.digital.hmpps.prisonestate.resource.PrisonResource
...
class SpringFoxConfiguration(buildProperties: BuildProperties) {
  ...
  @Bean
  fun api(): Docket {
    val apiInfo = ApiInfo("Prison Estate API Documentation", "API for providing Prison Estate information.",
    ...
    val docket = Docket(DocumentationType.SWAGGER_2)
        ...
        .apiInfo(apiInfo)
        .select()
        .apis(RequestHandlerSelectors.basePackage(PrisonResource::class.java.getPackage().getName()))
